...
namespace APIVerve
{
    public class SpamDetectorAPIClient
    {
        ...
        public SpamDetectorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public SpamDetectorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(spamdetectorQueryOptions options)
        {
            try
            {
                if (_isDebug)
